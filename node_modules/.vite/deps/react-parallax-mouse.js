...
// node_modules/react-spring/dist/cjs/react-spring.development.cjs
var require_react_spring_development = __commonJS({
  "node_modules/react-spring/dist/cjs/react-spring.development.cjs"(exports, module) {
    "use strict";
    var __defProp = Object.defineProperty;
    var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
    var __getOwnPropNames = Object.getOwnPropertyNames;
    ...
    var src_exports = {};
    module.exports = __toCommonJS(src_exports);
    __reExport(src_exports, require_cjs6(), module.exports);
  }
});

// node_modules/react-spring/dist/cjs/index.js
var require_cjs7 = __commonJS({
  "node_modules/react-spring/dist/cjs/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
      module.exports = require_react_spring_development();
    }
  }
});

// node_modules/react-parallax-mouse/dist/index.js
var require_dist = __commonJS({
  "node_modules/react-parallax-mouse/dist/index.js"(exports) {
    ...
    var a = { x: 0, y: 0 };
    var u = { x: new t.SpringValue(0), y: new t.SpringValue(0) };
    var i = e.createContext(u);
    var l = function() {
      return e.useContext(i);
    };
    exports.MouseParallaxChild = function(n2) {
      var a2 = n2.factorX, u2 = void 0 === a2 ? 1 : a2, i2 = n2.factorY, c = void 0 === i2 ? 1 : i2, s = n2.inverted, d = void 0 !== s && s, f = n2.className, v = n2.style, p = n2.children, m = l(), x = e.useCallback(function(e2) {
        return { x: e2.x.to(function(e3) {
          return e3 * u2 * (d ? -1 : 1);
        }), y: e2.y.to(function(e3) {
          return e3 * c * (d ? -1 : 1);
        }) };
      }, [u2, c]), y = o(o({}, x(m)), v);
      return r.default.createElement(r.default.Fragment, null, r.default.createElement(t.animated.div, { className: f, style: y }, p));
    }, exports.MouseParallaxContainer = function(n2) {
      var u2 = n2.globalFactorX, l2 = void 0 === u2 ? 1 : u2, c = n2.globalFactorY, s = void 0 === c ? 1 : c, d = n2.resetOnLeave, f = n2.useWindowMouseEvents, v = n2.inverted, p = n2.springConfig, m = n2.enabled, x = void 0 === m || m, y = n2.containerStyle, g = n2.className, w = n2.children, E = t.useSpring(function() {
        return o(o({}, a), p ? { config: p } : {});
      }), b = E[0], C = E[1], h = function() {
        return C.start(a);
      }, M = e.useState({ current: null }), S = M[0], L = M[1], O = e.useCallback(function(e2) {
        null !== e2 && L({ current: e2 });
      }, []), P = e.useCallback(function(e2) {
        var t2 = S.current ? S.current.getBoundingClientRect() : { left: 0, top: 0 };
        return { x: e2.clientX - t2.left, y: e2.clientY - t2.top };
      }, [S]), j = e.useCallback(function(e2) {
        if (S.current) {
          var t2 = S.current.clientHeight, n3 = S.current.clientWidth, r2 = P(e2), o2 = { x: (n3 / 2 - r2.x) * l2 * (v ? -1 : 1), y: (t2 / 2 - r2.y) * s * (v ? -1 : 1) };
          C.start(o2);
        }
      }, [S, P, v]);
      e.useEffect(function() {
        return x && f && S.current && (window.addEventListener("mousemove", j, false), d && window.addEventListener("mouseout", h, false)), function() {
          x && f && S.current && (window.removeEventListener("mousemove", j, false), d && window.removeEventListener("mouseout", h, false));
        };
      }, [S, j, d, f, x]);
      var k = { onMouseMove: x && !f ? j : void 0, onMouseLeave: x && !f && d ? h : void 0 };
      return r.default.createElement(i.Provider, { value: b }, r.default.createElement("div", o({ id: "mouse-parallax-container", ref: O, style: o({ overflow: "hidden", position: "relative" }, y), className: g }, k), w));
    }, exports.useParallaxOffset = l;
  }
});
export default require_dist();
//# sourceMappingURL=react-parallax-mouse.js.map
